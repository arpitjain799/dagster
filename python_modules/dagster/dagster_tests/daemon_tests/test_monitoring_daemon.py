...
def test_global_concurrency_release(
    ...
    run = create_run_for_test(instance, pipeline_name="my_job", status=DagsterRunStatus.STARTING)
    instance.event_log_storage.claim_concurrency_slots({"foo"}, run.run_id, "my_step")
